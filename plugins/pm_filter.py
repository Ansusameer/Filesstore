...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>🌟 Click Here For Any ʟᴏᴠᴇ ᴄᴏʀɴ & ᴊᴀᴠ? ɪ ᴀᴍ ᴍᴀᴅᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ғɪɴᴅ ᴡʜᴀᴛ ʏᴏᴜ'ʀᴇ ʟᴏᴏᴋɪɴɢ ꜰᴏʀ.ↆ \n\n🌟 ʟᴏᴠᴇ ᴄᴏʀɴ & ᴊᴀᴠ? ɪ ᴀᴍ ᴍᴀᴅᴇ ᴛᴏ ʜᴇʟᴘ ʏᴏᴜ ᴛᴏ ғɪɴᴅ ᴡʜᴀᴛ ʏᴏᴜ'ʀᴇ ʟᴏᴏᴋɪɴɢ ꜰᴏʀ.!!!ↆ</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🎬 Click Here 🧤", url=f"https://telegram.me/FabHouse_bkup")]])
    )
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [
                             [
                          InlineKeyboardButton('🔆彡[ FabHouse ]彡🔆', url=f'https://telegram.me/{CHNL_LNK}'),
                         ]
                            ]
                        )
                    )
